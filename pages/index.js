          ...
          <div className={classes.root}>
            ...
            <div className={classes.main}>
              <div className={classes.content}>
                ...
                <nav>
                  <Link className={classes.option} href='/websites' onLink={this.onLink}>
                    <Button animate show={anim.entered}>
                      {btnAnim => (
                        <Words animate show={btnAnim.entered}>Websites</Words>
                      )}
                    </Button>
                  </Link>
                  {' '}
                  <Link className={classes.option} href='/apps' onLink={this.onLink}>
                    <Button animate show={anim.entered}>
                      {btnAnim => (
                        <Words animate show={btnAnim.entered}>Apps</Words>
                      )}
                    </Button>
                  </Link>
                  {' '}
                  <Link className={classes.option} href='/contact' onLink={this.onLink}>
                    <Button animate show={anim.entered}>
                      {btnAnim => (
                        <Words animate show={btnAnim.entered}>Contact</Words>
                      )}
                    </Button>
                  </Link>
                </nav>
